...
Alex Krizhevsky, Vinod Nair and Geoffrey Hinton collected a data set called [80 million tiny images](http://groups.csail.mit.edu/vision/TinyImages/). A subset with only ten classes of images with single objects was created called [CIFAR-10](https://www.cs.toronto.edu/~kriz/cifar.html) where the [Canadian Institute of Advanced Research](https://en.wikipedia.org/wiki/Canadian_Institute_for_Advanced_Research) was the name donor.
